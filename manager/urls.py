...
re_path(r'^panel/manager/list/$', views.manager_list, name='manager_list'),   ## Manager List in Admin Panel
re_path(r'^panel/manager/del/(?P<pk>\d+)/$', views.manager_del, name='manager_del'),   ## Delete Manager List in Admin Panel
re_path(r'^panel/manager/group/$', views.manager_group, name='manager_group'),    ## Manager Group in Admin Panel
re_path(r'^panel/manager/group/add/$', views.manager_group_add, name='manager_group_add'),   ## Add Manager Group in Admin Panel
...
re_path(r'^panel/manager/perms/$', views.manager_perms, name='manager_perms'),   ## Manager Permissions in Admin Panel
...
re_path(r'^panel/manager/perms/add/$', views.manager_perms_add, name='manager_perms_add'),   ## Add Manager Permission in Admin Panel
